# -*- coding: utf-8 -*-
# Generated by Django 1.11.28 on 2020-07-06 14:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Id_number', models.CharField(max_length=21, null=True)),
                ('EquipName', models.CharField(choices=[('Laptop', 'Laptop'), ('Tablet', 'Tablet'), ('DestopMachine', 'DestopMachine')], default='Laptop', max_length=30, null=True)),
                ('Tel', models.CharField(max_length=30, null=True)),
                ('date', models.DateTimeField(auto_now_add=True, null=True)),
            ],
        ),
